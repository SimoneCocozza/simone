...
namespace AcademyWebAPI.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<Student>> Get([FromQuery(Name = "WithExam")] bool WithExam)//prendo il paramentro dalla query
        {
            if (WithExam)
            {
        ...
        public ActionResult DeleteStudent(int id)
        {
            ...
            switch(result.State)
            {
                case DeleteResult.DeleteState.NotExisting:
                    return NotFound();
                case DeleteResult.DeleteState.Deleted:
                    return Ok(result.RemovedObject);
                case DeleteResult.DeleteState.Error: return Ok(result);
                default:
                    return Problem();
